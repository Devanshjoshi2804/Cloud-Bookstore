      ...
      <section className="py-20">
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Don't just take our word for it — here's what our community of readers thinks about Cloud Bookstore.
            </p>
          </motion.div>
          ...
          >
            {testimonials.map((testimonial) => (
              <motion.div
                ...
                variants={itemVariants}
                className="p-6 rounded-xl border bg-background hover:shadow-lg transition-shadow duration-300"
              >
      ...
      <section className="py-20 bg-muted/30">
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              The passionate people behind Cloud Bookstore, dedicated to improving your reading experience.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container">
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="max-w-3xl mx-auto text-center bg-primary/5 p-12 rounded-2xl border"
          >
            <h2 className="text-3xl font-bold mb-4">Join Our Community</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Whether you're an avid reader or just getting started, Cloud Bookstore is here to
              enhance your reading journey. Join our growing community of book lovers today.
            </p>
